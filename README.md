...
- Switch between anonymous samples or scrub their shared playhead while both stay synchronized.
...
- Reveal stable Version 1/2 tags, full source paths, and the preference breakdown only after the test.
